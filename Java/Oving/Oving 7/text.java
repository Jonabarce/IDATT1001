    ...
    public static void main(String[] args) {
        ...
        while (go) {
            ...
            if(choice == 1){
                ...
                System.out.println( " Press 1 to find total letters in the text ");
                ...
                if (choice2 == 1){
                    ...
                    System.out.println(text1.totalletters());
                ...
                if (choice2 == 2){
                    ...
                    System.out.println(text1.averageWord());
                }
                ...
                System.out.println(text1.replaceWord(letter,letter2));
                }
